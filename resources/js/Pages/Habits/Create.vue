                ...
                <div class="feminine-panel overflow-hidden p-0">
                    <form @submit.prevent="submit" class="space-y-6 p-6 sm:p-8">
                        <div class="rounded-2xl border border-rose-100/80 bg-white/70 p-4">
                            <p class="text-xs font-semibold uppercase tracking-[0.15em] text-rose-500">Nuevo compromiso</p>
                            <p class="mt-1 text-sm text-rose-700">Crea un habito simple y mantenlo constante para ver resultados reales.</p>
                        </div>
