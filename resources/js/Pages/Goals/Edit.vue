                ...
                <div class="feminine-panel overflow-hidden p-0">
                    <form @submit.prevent="submit" class="space-y-6 p-6 sm:p-8">
                        <div class="rounded-2xl border border-rose-100/80 bg-white/70 p-4">
                            <p class="text-xs font-semibold uppercase tracking-[0.15em] text-rose-500">Optimiza tu plan</p>
                            <p class="mt-1 text-sm text-rose-700">Actualiza fechas y progreso para mantener claridad sobre el siguiente paso.</p>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4 border-t border-rose-100 pt-4">
                            <Link
                                :href="route('goals.show', props.goal.id)"
